...
import sys, threading, multiprocessing, queue, time
...
if __name__ == "__main__":
    ...
    h1 = threading.Thread(target=leer, args=(p_escritura,repeticion), name="h1")
    h2 = threading.Thread(target=encriptacion, args=(p_lectura,repeticion), name="h2")
    h1.start()
    h2.start()
    h1.join()
    h2.join()
